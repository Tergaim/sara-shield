...
RobotReach::RobotReach(double x = 0, double y = 0, double z = 0, double roll = 0, double pitch = 0, double yaw = 0, double radius = 0.5, double secure_radius=0.0):
  nb_joints_(1),
  secure_radius_(secure_radius)
{
  ...
  transformation_matrices_.push_back(transformation_matrix);
    ...
    robot_cylinder.push_back(cylinder);
  }
}
